...
const PRAYERS: PrayerDef[] = [
  { key: "fajr", name: "Fajr", icon: faStar, adhanKey: "fajr_adhan", jamaatKey: "fajr_jamaat" },
  { key: "sunrise", name: "Sunrise", icon: faSun, adhanKey: "sunrise", jamaatKey: "sunrise" },
  { key: "dhuhr", name: "Dhuhr", icon: faCloudSun, adhanKey: "dhuhr_adhan", jamaatKey: "dhuhr_jamaat" },
  { key: "asr", name: "Asr", icon: faCloudSun, adhanKey: "asr_adhan", jamaatKey: "asr_jamaat" },
  { key: "maghrib", name: "Maghrib", icon: faMoon, adhanKey: "maghrib_adhan", jamaatKey: "maghrib_jamaat" },
  { key: "isha", name: "Isha", icon: faMoon, adhanKey: "isha_adhan", jamaatKey: "isha_jamaat" },
];
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      isCurrent ? "bg-[#064E3B]/10 text-[#064E3B]" : "bg-[#C8A951]/10 text-[#C8A951]"
                    )}
                  >
                  ...
                  {isSunrise ? (
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div>
                        ...
                        <p className={cn("text-base font-bold", isCurrent ? "text-[#064E3B]" : "text-foreground")}>
                          {formatTime(jamaatTime)}
                        </p>
                      </div>
                    </div>
      ...
      <section className="overflow-hidden rounded-2xl border border-black/5 bg-white shadow-sm">
        ...
        {data.length === 0 ? (
          <div className="px-5 pb-6 text-center">
            <FontAwesomeIcon icon={faMosque} className="mb-3 h-10 w-10 text-[#064E3B]/20" />
            <p className="text-sm font-medium text-foreground">No prayer times yet</p>
                    ...
                    >
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className={cn("text-sm font-semibold", isToday ? "text-[#064E3B]" : "text-foreground")}>
      ...
      >
        <form action={handleCopy} className="space-y-5">
          ...
          <div className="flex items-start gap-3 rounded-xl border border-[#064E3B]/10 bg-[#064E3B]/[0.03] p-4">
            <FontAwesomeIcon icon={faStarAndCrescent} className="mt-0.5 h-3.5 w-3.5 shrink-0 text-[#064E3B]" />
            <p className="text-sm text-muted-foreground">
              Prayer times from the source date will be applied to every date between the source
              and target dates (excluding the source date itself).
            </p>
          </div>
          <div className="flex justify-end gap-2">
